...
table_detail = $('#table-detail').dataTable({
				...
				columns				:	[	{data:null,width:"5%"},
											...
											<?php foreach($title->table_column as $alias_field=>$val){?>
												{data:"<?php echo $alias_field ?>" ,										<?php if($alias_field=='no_hp'){?>
														 render: $.fn.dataTable.render.number( ',', '.', 2, '' ),<?php }?>

										<?php if($alias_field=='no_hp_lain'){?>
														 render: $.fn.dataTable.render.number( ',', '.', 2, '' ),<?php }?>

										<?php if($alias_field=='no_ktp'){?>
														 render: $.fn.dataTable.render.number( ',', '.', 2, '' ),<?php }?>

										<?php if($alias_field=='tahun_lulus'){?>
														 render: $.fn.dataTable.render.number( ',', '.', 2, '' ),<?php }?>

										<?php if($alias_field=='no_rekening'){?>
														 render: $.fn.dataTable.render.number( ',', '.', 2, '' ),<?php }?>

										<?php if($alias_field=='npwp'){?>
														 render: $.fn.dataTable.render.number( ',', '.', 2, '' ),<?php }?>
