...
<?php echo card_open('Form','bg-green',true)?>	
	...
	<form id='form-a'>
					...
					<div class='form-group'>
							...
							<select name='id' id="id" class="form-control custom-select data-sending">				
									...
									if ($list_agent_d['num'] > 0) {
										foreach ($list_agent_d['results'] as $list_agent) {
											...
											echo "<option value='" . $list_agent->id . "' " . $selected . ">" . $list_agent->nik_absensi . " | " . $list_agent->nama . "</option>";
					...
					<div class='form-group'>
							...
							<input name="waktu_in" type='text' class='form-control data-sending input-simple-date' placeholder='<?php echo $title->general->desc_required ?>' id='waktu_in' value='<?php if(isset($data)) echo $data->tanggal?>'>
							</div>
					</div>
					</div>
