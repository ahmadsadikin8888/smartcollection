...
<form id='form-a'>
	...
	<div class='col-md-12 col-xl-12'>
		<div class='form-group'>
			...
			<div class='input-group'>
				...
				<input readonly type='text' class='form-control data-sending input-simple-date' placeholder='<?php echo $title->general->desc_required ?>' id='tanggal' value='<?php if (isset($data)) echo $data->tanggal ?>'>
			</div>
		</div>
	</div>
	...
	<div class='col-md-12 col-xl-12'>
		<div class='form-group'>
			<label class='form-label'><?php echo $title->leader_on_duty_gelombang ?></label>
			<input type='text' class='form-control data-sending focus-color ybs-input-number' id='gelombang' name='gelombang' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if (isset($data)) echo number_format($data->gelombang, 2) ?>' autocomplete='off'>
		</div>
	</div>
