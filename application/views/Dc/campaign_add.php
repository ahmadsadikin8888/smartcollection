                    ...
                    <div class="col-md">
                        <div class="form">
                            <div class="form-group">
                                ...
                                <textarea class="form-control row-5" name="template_sms" onkeyup="countChar(this)"></textarea>
                                <div id="charNum"></div>
                            </div>
                            <div class="form-group">
                                <label for="temp_wa">Template Whatsapp</label>
                                <textarea class="temp_wa" name="tempalte_wa"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="temp_email">Template Email</label>
                                <textarea class="temp_email" name="template_email"></textarea>
                            </div>
