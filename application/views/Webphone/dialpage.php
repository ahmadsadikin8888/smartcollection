...
<head>
    ...
    <!---WEBPHONE-->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/webphone/css/softphone/index.css" />
    <!-- Themes -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/webphone/css/softphone/themes/wphone_1.0.css" />
    <!-- instead of: <link rel="stylesheet" href="css/jquery.mobile-1.4.2.min.css" />-->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/webphone/css/softphone/themes/jquery.mobile.icons.min.css" />
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/webphone/css/softphone/jquery.mobile.structure-1.4.2.css" />
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/webphone/css/softphone/mainlayout.css" />

    <script>
        window.pageissdk = false;
    </script>
    <script src="<?php echo base_url(); ?>assets/webphone/webphone_api.js?jscodeversion=827"></script>
</head>
<!-- END Head-->
...
<body id="main-container" class="default horizontal-menu">
                ...
                <div class="col-3" style="height:500px;">
                    ...
                    <div class="app" id="phone_app_main_container">
                        ...
                        <script type="text/javascript">
                            document.getElementById('js_not_enabled').style.display = 'none';
                            try {
                                document.getElementById('phone_app_main_container').style.display = 'none';
                            } catch (err) {}
                        </script>
                        ...
                        <li id="test_id"><a href="javascript:;" id="menuitem_test">View details</a></li>-->
                            ...
                            <div id="page_settings_content" role="main" class="ui-content" data-theme="b" data-content-theme="b">
                                ...
                                <div id="settings_copyright" style="display: none;">
                                    <a href="https://www.mizu-voip.com/Software/WebPhone.aspx" target="_blank" title="Provider">Powered
                                        by Mizutech WebPhone &reg;</a>
                                </div>
                                <div id="settings_engine" style="display: none;">
                                    <a href="javascript:;" target="_blank" id="btn_settings_engine" class="ui-btn noshadow btn_engine"><span id="settings_engine_title" class="engine_title">Choose
                                            engine</span><br /><span id="settings_engine_msg" class="engine_msg"></span></a>
                        ...
                        <div id="page_dialpad" class="all_app_pages" data-role="page" data-theme="b">
                            ...
                            <div id="dialpad_header" data-role="header">
                                <div id="dialpad_engine" style="display: none;">
                                    <a href="javascript:;" target="_blank" id="btn_dialpad_engine" class="ui-btn noshadow btn_engine"><span id="dialpad_engine_title" class="engine_title">Choose
                                            engine</span><br /><span id="dialpad_engine_msg" class="engine_msg"></span></a>
                                ...
                                <div id="dialpad_additional_header">
                                    ...
                                    <div class="additional_header_left" id="dialpad_additional_header_left">
                                        <div id="dialpad_presence"></div>
                                        <div><span id="app_name_dialpad"></span></div>
                                    </div>
                                    <div id="dialpad_title" class="additional_header_middle">Phone</div>
                                    <!--<div class="notification" id="dialpad_notification"></div>-->
                                ...
                                <div class="status_container">
                                    ...
                                    <div class="status" id="status_dialpad">&nbsp;</div>
                            ...
                            <div id="page_dialpad_content" role="main" class="ui-content">
                                <div class="ui-grid-a" id="phone_number_container">
                                    ...
                                    <div class="ui-block-b"><button id="btn_backspace" class="ui-btn-a noshadow"><img src="images/btn_backspace_txt.png" id="btn_backspace_img" alt="backspace" /></button>
                                    </div>
                                ...
                                <div class="ui-grid-b" id="dialpad_btn_grid">
                                    ...
                                    <div class="ui-block-a"><button id="btn_dp_ast" class="ui-btn noshadow"><span id="dialpad_asterisk" class="number">&lowast;</span><span class="smalltext">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></button>
                                    </div>
                                    ...
                                    <div class="ui-block-c"><button id="btn_dp_diez" class="ui-btn noshadow"><span class="number">#</span><span class="smalltext">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></button>
                                    </div>
                            ...
                            <div data-role="footer" data-tap-toggle="false" id="dialpad_footer">
                                <div class="ui-grid-b" id="dialpad_call_grid">
                                    ...
                                    <div class="ui-block-b" id="btn_call"><button class="ui-btn noshadow ui-btn-c"><img src="images/btn_call_txt.png" id="dp_btn_call_txt" alt="call" /></button></div>
                            ...
                            <div id="contactslist_header" data-role="header" data-theme="b">
                                <div id="contactslist_additional_header">
                                    ...
                                    <div class="additional_header_left" id="contactslist_additional_header_left">
                                        <div id="contactslist_presence"></div>
                                        <div><span id="app_name_contactslist"></span></div>
                                    </div>
                                    <div id="ctlist_title" class="additional_header_middle">Contacts</div>
                                    <!--<div class="notification" id="contactslist_notification"></div>-->
                                ...
                                <div class="status_container">
                                    <img src="images/icon_encrypt.png" class="img_encrypt" title="Encrypted">
                                    <div class="status" id="status_contactslist">&nbsp;</div>
                        ...
                        <div id="page_contactdetails" class="all_app_pages" data-role="page">
                            <div id="contactdetails_header" data-role="header" data-theme="b">
                                <div id="contactdetails_additional_header">
                                    <div class="additional_header_left">
                                        <a id="ctdetails_btnback" class="btn_header_back ui-btn" data-rel="back"><b>&LT;</b>&nbsp;All
                                            Contacts</a>
                                    </div>
                            ...
                            <div id="callhistorylist_header" data-role="header" data-theme="b">
                                <div id="callhistorylist_additional_header">
                                    ...
                                    <div class="additional_header_left" id="callhistorylist_additional_header_left">
                                        <div id="callhistorylist_presence"></div>
                                        <div><span id="app_name_callhistorylist"></span></div>
                                    </div>
                                    <div id="chlist_title" class="additional_header_middle">Call history</div>
                                    <!--<div class="notification" id="callhistorylist_notification"></div>-->
                                ...
                                <div class="status_container">
                                    <img src="images/icon_encrypt.png" class="img_encrypt" title="Encrypted">
                                    <div class="status" id="status_callhistorylist">&nbsp;</div>
                        ...
                        <div id="page_callhistorydetails" class="all_app_pages" data-role="page">
                            <div id="callhistorydetails_header" data-role="header" data-theme="b">
                                <div id="callhistorydetails_additional_header">
                                    <div class="additional_header_left">
                                        <a id="chdetails_btnback" class="btn_header_back ui-btn" data-rel="back"><b>&LT;</b>&nbsp;Call
                                            history</a>
                                    </div>
                        ...
                        <div id="page_call" class="all_app_pages" data-role="page" data-theme="b">
                            ...
                            <div id="page_call_content" role="main" class="ui-content">
                                ...
                                <div id="volumecontrols" style="display: none;">
                                    ...
                                    <div style="float: left; width: 90%; clear: both;">
                                        <!--//-->
                                    </div>
                                ...
                                <div id="numpad">
                                    ...
                                    <div class="ui-grid-b" id="numpad_btn_grid">
                                        <div class="ui-block-a"><button id="numpad_btn_dp_1" class="ui-btn noshadow"><span class="number">1</span><span class="smalltext">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></button>
                                        </div>
                                        ...
                                        <div class="ui-block-a"><button id="numpad_btn_dp_ast" class="ui-btn noshadow"><span class="number">&lowast;</span><span class="smalltext">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></button>
                                        </div>
                                        ...
                                        <div class="ui-block-c"><button id="numpad_btn_dp_diez" class="ui-btn noshadow"><span class="number">#</span><span class="smalltext">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></button>
                                        </div>
                                    </div>
                                    <div class="separator_color_bg">
                                        <!--//-->
                            ...
                            <div id="page_addeditcontact_content" role="main" class="ui-content" data-theme="b" data-content-theme="b">
                                <div id="aec_name_section">
                                    ...
                                    <div id="aec_add_section">
                                        ...
                                        <div id="aec_add"><button id="btn_add_aec" class="noshadow ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b ui-icon-plus ui-btn-icon-notext">Add</button>
                                        </div>
                                    </div>
                                </div>
                                <div id="aec_number_fields">
                                    <div id="aec_entry_0" style="display: none;" class="aec_numbers"><button id="btn_type_aec_0" class="aec_phonetype ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b noshadow">Mobile_</button><input id="number_aec_0" type="text" name="number" data-theme="a" autocapitalize="off" />
                                        <div id="btn_minus_aec_0" class="minus_btn"><button class="noshadow ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b ui-icon-minus ui-btn-icon-notext">Remove</button>
                                        </div>
                                    </div>
                                    <div id="aec_entry_1" style="display: none;" class="aec_numbers"><button id="btn_type_aec_1" class="aec_phonetype ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b noshadow">Mobile_</button><input id="number_aec_1" type="text" name="number" data-theme="a" autocapitalize="off" />
                                        <div id="btn_minus_aec_1" class="minus_btn"><button class="noshadow ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b ui-icon-minus ui-btn-icon-notext">Remove</button>
                                        </div>
                                    </div>
                                    <div id="aec_entry_2" style="display: none;" class="aec_numbers"><button id="btn_type_aec_2" class="aec_phonetype ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b noshadow">Mobile_</button><input id="number_aec_2" type="text" name="number" data-theme="a" autocapitalize="off" />
                                        <div id="btn_minus_aec_2" class="minus_btn"><button class="noshadow ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b ui-icon-minus ui-btn-icon-notext">Remove</button>
                                        </div>
                                    </div>
                                    <div id="aec_entry_3" style="display: none;" class="aec_numbers"><button id="btn_type_aec_3" class="aec_phonetype ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b noshadow">Mobile_</button><input id="number_aec_3" type="text" name="number" data-theme="a" autocapitalize="off" />
                                        <div id="btn_minus_aec_3" class="minus_btn"><button class="noshadow ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b ui-icon-minus ui-btn-icon-notext">Remove</button>
                                        </div>
                                    </div>
                                    <div id="aec_entry_4" style="display: none;" class="aec_numbers"><button id="btn_type_aec_4" class="aec_phonetype ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b noshadow">Mobile_</button><input id="number_aec_4" type="text" name="number" data-theme="a" autocapitalize="off" />
                                        <div id="btn_minus_aec_4" class="minus_btn"><button class="noshadow ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b ui-icon-minus ui-btn-icon-notext">Remove</button>
                                        </div>
                                    </div>
                                    <div id="aec_entry_5" style="display: none;" class="aec_numbers"><button id="btn_type_aec_5" class="aec_phonetype ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b noshadow">Mobile_</button><input id="number_aec_5" type="text" name="number" data-theme="a" autocapitalize="off" />
                                        <div id="btn_minus_aec_5" class="minus_btn"><button class="noshadow ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b ui-icon-minus ui-btn-icon-notext">Remove</button>
                                        </div>
                                    </div>
                                    <div id="aec_entry_6" style="display: none;" class="aec_numbers"><button id="btn_type_aec_6" class="aec_phonetype ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b noshadow">Mobile_</button><input id="number_aec_6" type="text" name="number" data-theme="a" autocapitalize="off" />
                                        <div id="btn_minus_aec_6" class="minus_btn"><button class="noshadow ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b ui-icon-minus ui-btn-icon-notext">Remove</button>
                                        </div>
                                    </div>
                                    <div id="aec_entry_7" style="display: none;" class="aec_numbers"><button id="btn_type_aec_7" class="aec_phonetype ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b noshadow">Mobile_</button><input id="number_aec_7" type="text" name="number" data-theme="a" autocapitalize="off" />
                                        <div id="btn_minus_aec_7" class="minus_btn"><button class="noshadow ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b ui-icon-minus ui-btn-icon-notext">Remove</button>
                                        </div>
                                    </div>
                                    <div id="aec_entry_8" style="display: none;" class="aec_numbers"><button id="btn_type_aec_8" class="aec_phonetype ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b noshadow">Mobile_</button><input id="number_aec_8" type="text" name="number" data-theme="a" autocapitalize="off" />
                                        <div id="btn_minus_aec_8" class="minus_btn"><button class="noshadow ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b ui-icon-minus ui-btn-icon-notext">Remove</button>
                                        </div>
                                    </div>
                                    <div id="aec_entry_9" style="display: none;" class="aec_numbers"><button id="btn_type_aec_9" class="aec_phonetype ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b noshadow">Mobile_</button><input id="number_aec_9" type="text" name="number" data-theme="a" autocapitalize="off" />
                                        <div id="btn_minus_aec_9" class="minus_btn"><button class="noshadow ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b ui-icon-minus ui-btn-icon-notext">Remove</button>
                                        </div>
                                    </div>
                                    <div id="aec_entry_10" style="display: none;" class="aec_numbers"><button id="btn_type_aec_10" class="aec_phonetype ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b noshadow">Mobile_</button><input id="number_aec_10" type="text" name="number" data-theme="a" autocapitalize="off" />
                                        <div id="btn_minus_aec_10" class="minus_btn"><button class="noshadow ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b ui-icon-minus ui-btn-icon-notext">Remove</button>
                                        </div>
                                    </div>
                                    <div id="aec_entry_11" style="display: none;" class="aec_numbers"><button id="btn_type_aec_11" class="aec_phonetype ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b noshadow">Mobile_</button><input id="number_aec_11" type="text" name="number" data-theme="a" autocapitalize="off" />
                                        <div id="btn_minus_aec_11" class="minus_btn"><button class="noshadow ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b ui-icon-minus ui-btn-icon-notext">Remove</button>
                                        </div>
                                    </div>
                                    <div id="aec_entry_12" style="display: none;" class="aec_numbers"><button id="btn_type_aec_12" class="aec_phonetype ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b noshadow">Mobile_</button><input id="number_aec_12" type="text" name="number" data-theme="a" autocapitalize="off" />
                                        <div id="btn_minus_aec_12" class="minus_btn"><button class="noshadow ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b ui-icon-minus ui-btn-icon-notext">Remove</button>
                                        </div>
                                    </div>
                                    <div id="aec_entry_13" style="display: none;" class="aec_numbers"><button id="btn_type_aec_13" class="aec_phonetype ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b noshadow">Mobile_</button><input id="number_aec_13" type="text" name="number" data-theme="a" autocapitalize="off" />
                                        <div id="btn_minus_aec_13" class="minus_btn"><button class="noshadow ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b ui-icon-minus ui-btn-icon-notext">Remove</button>
                                        </div>
                                    </div>
                                    <div id="aec_entry_14" style="display: none;" class="aec_numbers"><button id="btn_type_aec_14" class="aec_phonetype ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b noshadow">Mobile_</button><input id="number_aec_14" type="text" name="number" data-theme="a" autocapitalize="off" />
                                        <div id="btn_minus_aec_14" class="minus_btn"><button class="noshadow ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b ui-icon-minus ui-btn-icon-notext">Remove</button>
                                        </div>
                                    </div>
                                    <div id="aec_entry_15" style="display: none;" class="aec_numbers"><button id="btn_type_aec_15" class="aec_phonetype ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b noshadow">Mobile_</button><input id="number_aec_15" type="text" name="number" data-theme="a" autocapitalize="off" />
                                        <div id="btn_minus_aec_15" class="minus_btn"><button class="noshadow ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b ui-icon-minus ui-btn-icon-notext">Remove</button>
                                        </div>
                                    </div>
                                    <div id="aec_entry_16" style="display: none;" class="aec_numbers"><button id="btn_type_aec_16" class="aec_phonetype ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b noshadow">Mobile_</button><input id="number_aec_16" type="text" name="number" data-theme="a" autocapitalize="off" />
                                        <div id="btn_minus_aec_16" class="minus_btn"><button class="noshadow ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b ui-icon-minus ui-btn-icon-notext">Remove</button>
                                        </div>
                                    </div>
                                    <div id="aec_entry_17" style="display: none;" class="aec_numbers"><button id="btn_type_aec_17" class="aec_phonetype ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b noshadow">Mobile_</button><input id="number_aec_17" type="text" name="number" data-theme="a" autocapitalize="off" />
                                        <div id="btn_minus_aec_17" class="minus_btn"><button class="noshadow ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b ui-icon-minus ui-btn-icon-notext">Remove</button>
                                        </div>
                                    </div>
                                    <div id="aec_entry_18" style="display: none;" class="aec_numbers"><button id="btn_type_aec_18" class="aec_phonetype ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b noshadow">Mobile_</button><input id="number_aec_18" type="text" name="number" data-theme="a" autocapitalize="off" />
                                        <div id="btn_minus_aec_18" class="minus_btn"><button class="noshadow ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b ui-icon-minus ui-btn-icon-notext">Remove</button>
                                        </div>
                                    </div>
                                    <div id="aec_entry_19" style="display: none;" class="aec_numbers"><button id="btn_type_aec_19" class="aec_phonetype ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b noshadow">Mobile_</button><input id="number_aec_19" type="text" name="number" data-theme="a" autocapitalize="off" />
                                        <div id="btn_minus_aec_19" class="minus_btn"><button class="noshadow ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b ui-icon-minus ui-btn-icon-notext">Remove</button>
                                        </div>
                                    </div>

                                    <div class="separator_line_thick" id="aec_details_separator">
                                        <!--//-->
                                    </div>
                                    <div id="aec_add_deatils">
                                        <div id="aec_label_details">Add field_</div>
                                        <div id="aec_add_detailsbtn"><button id="btn_add_aec_details" class="noshadow ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b ui-icon-plus ui-btn-icon-notext">Add</button>
                                        </div>
                                    </div>
                                    ...
                                    <div id="aec_entry_address" class="aec_details" style="display: none;">
                                        <label>Address_:</label><input id="number_aec_address" type="text" name="number" data-theme="a" />
                                    </div>
                                    ...
                                    <div id="aec_entry_website" class="aec_details" style="display: none;">
                                        <label>Website_:</label><input id="number_aec_website" type="text" name="number" data-theme="a" autocapitalize="off" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="page_messagelist" class="all_app_pages" data-role="page">
                            ...
                            <div id="messagelist_header" data-role="header" data-theme="b">
                                <div id="messagelist_additional_header">
                                    ...
                                    <div id="msglist_title" class="additional_header_middle">Mesages</div>
                                    <!--<div class="notification" id="messagelist_notification"></div>-->
                        ...
                        <div id="page_filters" class="all_app_pages" data-role="page">
                            ...
                            <div role="main" class="ui-content" id="page_filters_content" data-theme="b" data-content-theme="b">
                                <div id="filters_add_section">
                                    ...
                                    <div id="filters_add"><button id="btn_add_filters" class="noshadow ui-btn-inline ui-btn ui-btn-corner-all ui-btn-b ui-icon-plus ui-btn-icon-notext">Add</button>
                                    </div>
                                </div>
    ...
    <script>
        ...
        function get_number() {
            ...
            $.ajax({
                url: "<?php echo base_url() . "Webphone/Webphone/get_phonenumber" ?>",
                methode: "get",
                dataType: 'JSON',
                success: function(response) {
                    // Properties of the gauge
                    $("#number_dial").val(response);
                }
            });
        }
        ...
        function runningwell() {
            setInterval(function() {
                var register_check = $("#status_dialpad").text();
                $("#status_register").val(register_check);
                $("#status_highlight").text(register_check);
                if (register_check == 'Registered.') {
                    ...
                    if (!in_call) {
                        if (status_ready == 1) {
                            ...
                            get_number();
                            // alert(number_call);
                            var number_call = $("#number_dial").val();
                            if (number_call != '0') {
                                webphone_api.call(number_call);
                            }
                        }
                    }
                }
