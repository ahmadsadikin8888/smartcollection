...
<?php echo card_open('Daftar Pengguna','bg-teal',true)?>

<div class="row">
<div class="col-md-6 col-lg-4">
<?php echo button_card("Buat Baru","new single user",'text-green','btn-success','fe fe-user','bg-green','btn-create',$link_create)?>
</div>
<div class="col-md-6 col-lg-4">
<?php echo button_card("Buat Baru","upload from file excel",'text-blue','btn-info','fe fe-users','bg-blue','btn-create',$link_create_multiple)?>
</div>
<div class="col-md-6 col-lg-4">
