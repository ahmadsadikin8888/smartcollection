...
<div class='row'>
	<div class="col-sm-12 col-lg-6"> 
		<?php echo button_card(
			"Error Report",
			"Disable/Enable error_reporting",
			"text-red",
			"btn-info",
			"fe fe-activity",
			"bg-red",
...
<div class='row'>
	...
	<div class="col-sm-12 col-lg-6"> 
		<?php echo button_card(
			"Run Page Maintenance",
			"redirect all to page maintenance",
			"text-blue",
			"btn-info",
			"fe fe-airplay",
			"bg-green",
			"btn-monitoring",
			$link_maintenance_setting
		) ?> 
	</div>
