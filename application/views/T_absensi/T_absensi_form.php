...
<form id='form-a'>
	...
	<div class='col-md-12 col-xl-12'>
		<div class='form-group'>
			<label class='form-label'><?php echo $title->t_absensi_nik ?></label>
			<?php $v = '';
			if (isset($data)) $v = $data->nik;
			echo create_cmb_database(array(
				'id'			=> 'nik',
				'name'			=> 'nik',
				'table'			=> 'sys_user',
				'field_show'	=> 'nik_absensi,nama',
				'primary_key'	=> 'nik_absensi',
				'selected'		=> $v,
				'field_link'	=> '',
	...
	<div class='col-md-12 col-xl-12'>
		<div class='form-group'>
			<label class='form-label'><?php echo $title->t_absensi_stts ?></label>
			<?php $v = '';
			if (isset($data)) $v = $data->stts;
			echo create_cmb_database(array(
				'id'			=> 'stts',
				'name'			=> 'stts',
				'table'			=> 'status_absen',
	...
	<div class='col-md-12 col-xl-12'>
		<div class='form-group'>
			<label class='form-label'><?php echo $title->t_absensi_waktu_in ?></label>
			<div class='input-group'>
				<span class='input-group-prepend' id='basic-addon1'>
					<span class='input-group-text'><i class="fa fa-calendar"></i></span>
				</span>
				<input readonly type='text' class='form-control data-sending input-simple-date' placeholder='<?php echo $title->general->desc_required ?>' id='waktu_in' value='<?php if (isset($data)) echo $data->waktu_in ?>'>
			</div>
		</div>
	</div>
