                    ...
                    <div class="col-6">
                        <div class="form">
                            ...
                            <div class="form-group row mt-3 ">
                                <label class="mt-2">No.Internet </label>
                                ...
                                <table id="datalist" class="table dataTable table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td>1</td>
                                                <td style='text-align:center;'><a href="<?php echo base_url() . "Ebs/Ebs/detail/" . $row_data['no_internet']; ?>" class="btn btn-primary"><?php echo $row_data['group_id']; ?></a></td>
                                                <td><?php echo $row_data['email']; ?></td>
                                                <td style='text-align:center;'><?php echo $row_data['ncli']; ?></td>
                                                <td style='text-align:center;'><?php echo $row_data['no_internet']; ?></td>
                                                <td style='text-align:center;'><?php echo $row_data['no_telepon']; ?></td>
                                                <td style='text-align:center;' nowrap><?php echo $row_data['nama']; ?></td>
                                                <!-- <td style='text-align:center;' nowrap><?php echo $row_data['alamat']; ?></td> -->
                                                <td style='text-align:center;'><?php echo $row_data['ba']; ?></td>
                                                <td style='text-align:center;'><?php echo $row_data['centite']; ?></td>
                                            </tr>
                                        <?php
                                            //     }
                                            // }
