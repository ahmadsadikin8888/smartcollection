...
<form id='form-a'>
	...
	<div class='col-md-12 col-xl-12'>
		<div class='form-group'>
			<label class='form-label'><?php echo $title->status_call_id_reason ?></label>
			<input type='text' class='form-control data-sending focus-color' id='id_reason' name='id_reason' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if (isset($data)) echo $data->id_reason ?>'>
		</div>
	</div>
	...
	<div class='col-md-12 col-xl-12'>
		<div class='form-group'>
			<label class='form-label'><?php echo $title->status_call_nama_reason ?></label>
			<input type='text' class='form-control data-sending focus-color' id='nama_reason' name='nama_reason' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if (isset($data)) echo $data->nama_reason ?>'>
		</div>
	</div>
